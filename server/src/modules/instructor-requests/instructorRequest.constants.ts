...
export const INSTRUCTOR_REQUEST_MESSAGES = {
  ...
  REVIEWED: "Instructor application reviewed successfull",
  UPDATED: "Instructor application updated successfull",
  FETCHED: "Fetched all instructor requests",
  ...
  DELETED: "Instructor request is deleted",
